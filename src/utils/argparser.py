...
def parse_args():
    ...
    create_parser.add_argument('page_path', help='название страницы для создания')
    create_parser.add_argument('template_path', help='путь к файлу шаблона, иначе будет пустая страница ')

    delete_parser = page_subparsers.add_parser('delete')
    delete_parser.add_argument('page_path', help='название страницы для удаления')
